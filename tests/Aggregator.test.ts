...
describe("Function checks", () =>{
  test("Add behaviours", ()=>{
    ...
    behaviourAggregator.setBehaviour(<HueBehaviourWrapperTwilight>twilightDim50AllDay,SPHERE_LOCATION);
    behaviourAggregator.setBehaviour(<HueBehaviourWrapperBehaviour>switchOn10AllDay,SPHERE_LOCATION);
  ...
  test('Light should stay off', () =>{
    ...
    const behaviourAggregator = new BehaviourAggregator(light.setState.bind(light),{on:true, bri:100});
    behaviourAggregator.setBehaviour(<HueBehaviourWrapperBehaviour>switchOn10AllDay,SPHERE_LOCATION)
    behaviourAggregator._loop();
